...
const CinemaSeatBooking1 = ({
  ...
  const handleSeatClick = (rowIndex, seatIndex) => {
    console.log("RRR111", rowIndex, seatIndex);
  ...
  console.log("Selected Seats 200", selectedSeats);

  const renderSeatSection = (seatRow, startIndex, endIndex) => {
    console.log(seatRow, startIndex);
    return (
      <div className="flex">
...
export default CinemaSeatBooking1;
